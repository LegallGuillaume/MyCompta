...
if __name__ == "__main__":
    if args.init:
        ...
        l_db = [AssuranceDAO(), FactureDAO(), WithdrawDAO(), ClientDAO(), CoffreDAO(), ProfileDAO()]
        tab = 15
        for l in l_db:
